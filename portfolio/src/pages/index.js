    ...
    this.projects = [
      {
        ...
        description: 'Fully responsive, serverless, progressive web app for small restaurants, with integrated simple booking system and basic administration tools for staff.',
      ...
      },
      {
        ...
        description: 'Responsive App based on React.js library for event management. Within Eventoo you can create your own events.',
      ...
      },
      {
        ...
        description: 'Responsive, mobile first webiste based on Gatsby.js. PSD to HTML',
  ...
  render () {
    return (
      <Layout>
        ...
        <Contact ref={this.contactSection} email='christopher.sordyl@gmail.com' />
        <Footer />
      </Layout>
    )
  }
