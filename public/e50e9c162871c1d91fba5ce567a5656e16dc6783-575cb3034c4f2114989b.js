  ...
  [0],
  {
    ...
    '9CUm': function (t, e, n) {
      ...
      function c(t) {
        var e = t.description,
          ...
          a = t.title,
          c = r.data.site
        e || c.siteMetadata.description
        return i.a.createElement(u.a, {
          htmlAttributes: { lang: n },
          title: a,
          titleTemplate: '' + c.siteMetadata.title,
          meta: [
            { name: 'description', content: c.siteMetadata.description },
            { property: 'og:title', content: c.siteMetadata.title },
            { property: 'og:description', content: c.siteMetadata.description },
            { property: 'og:type', content: 'website' },
            { name: 'twitter:card', content: 'summary' },
            { name: 'twitter:creator', content: c.siteMetadata.twitterSlug },
            { name: 'twitter:title', content: c.siteMetadata.title },
            {
              name: 'twitter:description',
              content: c.siteMetadata.description,
            },
          ].concat(o),
        })
      }
    ...
    AHZl: function (t) {
      t.exports = JSON.parse(
        '{"data":{"site":{"siteMetadata":{"title":"Krzysztof Sordyl Frontend Developer","description":"Welcome, my name is Krzysztof Sordyl frontend developer living in Bielsko-Biała, Poland. I\\"m creating solid, modern and well-designed websites. React enthusiast. Software, programming Bielsko-Biała","author":"Krzysztof Sordyl","twitterSlug":"@chsordyl"}}}}'
      )
    },
    Gytx: function (t, e, n) {
      n('2Spj'),
    ...
    Oyvg: function (t, e, n) {
      ...
      if (
        ...
        for (
          ...
          d(A[S++])
        ;(T.constructor = s), (s.prototype = T), n('KroJ')(r, 'RegExp', s)
      }
      n('elZq')('RegExp')
    },
    TJpk: function (t, e, n) {
          ...
          return (function t(e, n) {
            ...
            if (e && n && 'object' == typeof e && 'object' == typeof n) {
              ...
              var f = e instanceof Date,
                p = n instanceof Date
              if (f != p) return !1
              if (f && p) return e.getTime() == n.getTime()
        ...
        ;(e.convertReactPropstoHtmlAttributes = function (t) {
          ...
          (e.mapStateOnServer = function (t) {
            ...
            return {
              ...
              script: I(u.TAG_NAMES.SCRIPT, s, r),
...
//# sourceMappingURL=e50e9c162871c1d91fba5ce567a5656e16dc6783-575cb3034c4f2114989b.js.map
