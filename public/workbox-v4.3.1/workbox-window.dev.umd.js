  ...
  */
  ...
  var Workbox =
    ...
    (function (_EventTargetShim) {
        ...
        return _invoke(
          ...
          function () {
            ...
            _this2._compatibleControllingSW =
              _this2._getControllingSWIfCompatible()
            return _await(
              _this2._registerScript(),
              function (_this2$_registerScrip) {
                ...
                if (_this2._compatibleControllingSW) {
                  ...
                  _this2._activeDeferred.resolve(
                    _this2._compatibleControllingSW
                  )
...

                {
                  ...
                  var currentPageIsOutOfScope =
                    function currentPageIsOutOfScope() {
                      var scopeURL = new URL(
                        _this2._registerOptions.scope || _this2._scriptURL,
                        document.baseURI
                      )
                      var scopeURLBasePath = new URL('./', scopeURL.href)
                        .pathname
      ...
      _proto._getControllingSWIfCompatible =
        function _getControllingSWIfCompatible() {
