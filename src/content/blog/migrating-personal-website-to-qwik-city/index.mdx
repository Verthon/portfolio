...
import performanceBlog from './performance-blog.jpg'
...
<ArticleContent>
<Heading tag='h2' id='motivation' linkLabel='Link to heading: Motivation'>Motivation</Heading>
...
<Heading tag="h2" id="react-components" linkLabel="Link to heading: React components">React components</Heading>
...
<Heading tag="h2" id="tests" linkLabel="Link to heading: Tests">Tests</Heading>
...
<Heading tag="h2" id="pwa-support" linkLabel="Link to heading: PWA support">PWA support</Heading>
...
<Heading tag="h2" id="deployment" linkLabel="Link to heading: Deployment">Deployment</Heading>
