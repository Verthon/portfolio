...
description: 'Three years maintaining a shared npm library across thirty-plus apps we did not own, and how its API surface became permanent by accident.'
tags: architecture
date: 2026-02-14
...
og_description: War stories from a shared platform library, Hyrum's Law, and the politics of scaling a core npm package in a big organization.
---
...
<Heading
  tag="h2"
  id="standardization-trap"
  linkLabel="Link to heading: The Standardization Trap"
>
...
<Heading tag="h2" id="hyrums-law" linkLabel="Link to heading: Hyrum's Law">
  Hyrum's Law
</Heading>
...
<Heading tag="h2" id="politics" linkLabel="Link to heading: Politics">
  Politics
</Heading>
