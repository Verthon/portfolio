...
<Heading
  tag="h2"
  id="what-is-webpack"
  linkLabel="Link to heading: What is Webpack"
>
  What is Webpack
</Heading>
...
<Heading tag="h2" id="core-concepts" linkLabel="Link to heading: Core concepts">
  Core concepts
</Heading>
...
<Heading tag="h2" id="why-webpack" linkLabel="Link to heading: Why Webpack?">
  Why Webpack?
</Heading>
...
<Heading
  tag="h2"
  id="setting-up-npm"
  linkLabel="Link to heading: Setting up npm"
>
  Setting up npm
</Heading>
...
<Heading
  tag="h2"
  id="unified-node-version"
  linkLabel="Link to heading: Unified Node version"
>
...
<Heading
  tag="h2"
  id="additional-setup-for-npm"
  linkLabel="Link to heading: Additional setup for npm"
>
...
<Heading
  ...
  linkLabel="Link to heading: Install dependencies"
>
...
<Heading
  tag="h2"
  id="base-tsconfig"
  linkLabel="Link to heading: Base tsconfig.json"
>
  Base tsconfig.json
</Heading>
...
<Heading
  tag="h2"
  id="add-minimal-webpack-build-configuration"
  linkLabel="Link to heading: Add minimal Webpack build configuration"
>
...
<Heading
  tag="h2"
  id="example-entry-file"
  linkLabel="Link to heading: Example entry file and build command"
>
