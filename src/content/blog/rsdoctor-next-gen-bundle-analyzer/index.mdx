...
import rsdoctorMenu from './rsdoctor-menu.jpg'
import rsdoctorJsAndTotal from './rsdoctor-js-and-total.jpg'
import rsdoctorCss from './rsdoctor-css.jpg'
import rsdoctorTreeGraph from './rsdoctor-tree-graph.jpg'
...
<Heading tag="h2" id="rsdoctor-bundler-support" linkLabel="Link to heading: RSDoctor bundler support">RSDoctor bundler support</Heading>
...
<Heading tag="h2" id="features-breakdown" linkLabel="Link to heading: RSDoctor features breakdown">RSDoctor features breakdown</Heading>
...
<Heading tag="h3" id="bundle-size-analysis" linkLabel="Link to heading: Bundle size analysis">Bundle size analysis</Heading>
...
<ArticleImage
  src={rsdoctorTreeGraph}
  caption="Tree graph breakdown of the react chunk"
  ariaLabelledBy="rsdoctor-tree-graph"
/>

<Heading tag="h3" id="compilation-visualization" linkLabel="Link to heading: Compilation Visualization">Compilation Visualization</Heading>
...
<Heading tag="h3" id="general" linkLabel="Link to heading: General info">General info</Heading>
