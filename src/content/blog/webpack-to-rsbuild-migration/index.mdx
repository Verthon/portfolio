---
title: Migrating 30+ apps from Webpack to RSBuild with shared scripts
...
<ArticleWrapper>
<ArticleHeader>
<Heading tag='h1'>Migrating 30+ apps from Webpack to RSBuild with shared scripts</Heading>
</ArticleHeader>
...
<Heading
  ...
  linkLabel="Link to heading: Organization context"
>
...
<Heading tag="h2" id="problem-space" linkLabel="Link to heading: Problem space">
  Problem space
</Heading>
...
<Heading
  tag="h3"
  id="problem-space-scattered-ownership"
  linkLabel="Link to heading: Scattered ownership"
>
  Scattered ownership
</Heading>
...
<Heading
  tag="h3"
  id="problem-space-developer-experience"
  linkLabel="Link to heading: Developer experience not good enough"
>
  Developer experience not good enough
</Heading>
...
<Heading
  tag="h3"
  id="problem-space-path-forward"
  linkLabel="Link to heading: Path forward"
>
  Path forward
</Heading>
...
<Heading tag="h2" id="why-rsbuild" linkLabel="Link to heading: Why RSBuild">
  Why RSBuild
</Heading>
...
<Heading
  tag="h3"
  id="why-rsbuild-vite-evaluation"
  linkLabel="Link to heading: Vite was tempting"
>
  Vite was tempting
</Heading>
...
<Heading
  tag="h3"
  id="why-rsbuild-rsbuild-pros"
  linkLabel="Link to heading: RSBuild checked every box"
>
  RSBuild checked every box
</Heading>
...
<Heading
  ...
  linkLabel="Link to heading: Migration process"
>
  Migration process
</Heading>
...
<Heading
  tag="h3"
  id="migration-process-experimental-phase"
  linkLabel="Link to heading: Phase 1: Experimental Rollout (Q1-Q2 2024)"
>
  Phase 1: Experimental Rollout (Q1-Q2 2024)
</Heading>
...
<Heading
  tag="h3"
  id="migration-process-default"
  linkLabel="Link to heading: Phase 2: Default Migration"
>
...
<Heading tag="h2" id="outcomes" linkLabel="Link to heading: Outcomes">
  Outcomes
</Heading>

<Heading
  tag="h3"
  id="outcomes-performance"
  linkLabel="Link to heading: Performance"
>
  Performance
</Heading>
...
<Heading
  tag="h3"
  id="outcomes-developer-experience"
  linkLabel="Link to heading: Developer experience"
>
...
- lack of Vite is no longer a problem <span role="img" aria-label="winking face">😉</span>
- faster onboarding for devs, less dependencies to reduce cognitive load

<Heading
  tag="h3"
  id="outcomes-strategic-impact"
  linkLabel="Link to heading: Strategic impact"
>
  Strategic impact
</Heading>
- ~20-30% reduction in CI compute time across the platform - zero rollbacks for
phase 2 default migration - one package to update instead of 30+ repos with
stale dependencies - we already added `experimental-vite` option (Vite with
Rolldown on the way) - time saved NOT doing manual migrations (30+ apps x 8-16
hours)

<Heading
  tag="h2"
  id="what-could-go-better"
  linkLabel="Link to heading: What could go better"
>
...
<Heading
  tag="h3"
  id="improvements-initial-data-collection"
  linkLabel="Link to heading: Initial migration data gathering"
>
  Initial migration data gathering
</Heading>
...
<Heading
  tag="h3"
  id="improvements-team-reported-ci-metrics"
  linkLabel="Link to heading: CI metrics should be infrastructure-level"
>
  CI metrics should be infrastructure-level
</Heading>
...
<Heading
  tag="h3"
  id="improvements-starter-kit-release"
  linkLabel="Link to heading: Scripts should've existed from day one"
>
  Scripts should've existed from day one
</Heading>
...
<Heading
  tag="h3"
  id="improvements-initial-roi"
  linkLabel="Link to heading: Lack of ROI calculation framework"
>
  Lack of ROI calculation framework
</Heading>
