---
title: 'Modern Webpack Boilerplate: Part 3: Assets, Testing, Analysis'
description: Asset management, Jest unit testing, CSS configuration and a bundle analyzer for build-size monitoring, added to the Webpack boilerplate.
...
<ArticleWrapper>
<ArticleHeader>
<Heading tag='h1'>Modern Webpack Boilerplate: Part 3: Assets, Testing, Analysis</Heading>
</ArticleHeader>
...
<Heading tag="h2" id="unit-testing-setup" linkLabel="Link to heading: Unit testing setup">Unit testing setup</Heading>
...
<Heading tag="h2" id="asset-handling" linkLabel="Link to heading: Asset handling">Asset handling</Heading>
...
<Heading tag="h2" id="css-setup" linkLabel="Link to heading: CSS setup">CSS setup</Heading>
...
<Heading tag="h2" id="bundle-size-observability" linkLabel="Link to heading: Bundle size observability">Bundle size observability</Heading>
