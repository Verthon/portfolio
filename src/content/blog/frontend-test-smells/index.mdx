...
<Heading
  tag="h2"
  id="using-the-fireEvent-for-user-interactions"
  linkLabel="Link to heading: Using the `fireEvent` for user interactions"
>
...
<Heading
  tag="h2"
  id="lack-of-using-setup-for-userEvenet"
  linkLabel="Link to heading: Lack of using setup for `userEvent`"
>
...
<Heading
  tag="h2"
  id="lack-of-using-await-for-user-events"
  linkLabel="Link to heading: Lack of using await for the `user events`"
>
...
<Heading
  tag="h2"
  id="huge-test-cases"
  linkLabel="Link to heading: Huge test cases"
>
  Huge test cases
</Heading>
...
<Heading
  ...
  linkLabel="Link to heading: Too many assertions in one test case"
>
...
<Heading
  tag="h2"
  id="lack-of-useful-assertions"
  linkLabel="Link to heading: Lack of any assertions or assertion which are useless"
>
...
<Heading
  tag="h2"
  id="lack-of-strongly-typed-response-mocks"
  linkLabel="Link to heading: Lack of strongly typed response mocks"
>
...
<Heading
  tag="h2"
  id="badly-described-test-cases"
  linkLabel="Link to heading: Badly described test cases"
>
...
<Heading
  tag="h2"
  id="tests-that-sometimes-pass-sometimes-not"
  linkLabel="Link to heading: Tests that sometimes pass, sometimes not"
>
  Tests that sometimes pass, sometimes not
</Heading>
...
<Heading
  tag="h2"
  id="logic-in-tests"
  linkLabel="Link to heading: Logic in your tests"
>
  Logic in your tests
</Heading>
...
<Heading
  tag="h2"
  id="hard-to-write-tests"
  linkLabel="Link to heading: It is hard to write any tests"
>
...
<Heading
  tag="h2"
  id="tests-duplication"
  linkLabel="Link to heading: Tests duplication"
>
  Tests duplication
</Heading>
...
<Heading
  tag="h2"
  id="very-high-coverage"
  linkLabel="Link to heading: Very high coverage (90%+)"
>
...
<Heading
  tag="h2"
  id="very-slow-tests"
  linkLabel="Link to heading: Very slow tests"
>
  Very slow tests
</Heading>
...
<Heading
  ...
  linkLabel="Link to heading: Mocking everything"
>
  Mocking everything
</Heading>
...
<Heading
  tag="h2"
  id="tests-initially-always-pass"
  linkLabel="Link to heading: Tests initially always pass ✅"
>
  Tests initially always pass ✅
</Heading>
...
<Heading
  tag="h2"
  id="tests-as-living-documentation"
  linkLabel="Link to heading: Tests don't act as living documentation"
>
...
<Heading
  tag="h2"
  id="lack-of-any-test"
  linkLabel="Link to heading: Lack of any test"
>
  Lack of any test
</Heading>
...
<Heading tag="h3" id="material-that-helped" linkLabel="Link to heading: Material that helped me a lot preparing this article">
