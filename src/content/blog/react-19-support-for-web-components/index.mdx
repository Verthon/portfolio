...
<Heading
  tag="h2"
  id="before-react-19-era"
  linkLabel="Link to heading: Before React 19 era"
>
  Before React 19 era
</Heading>
...
<Heading
  tag="h3"
  id="unknown-props-treated-as-html-attributes"
  linkLabel="Link to heading: Unknown props treated as HTML attributes"
>
...
<Heading
  tag="h3"
  id="event-handling"
  linkLabel="Link to heading: Event handling"
>
  Event handling
</Heading>
...
<Heading tag="h3" id="ssr-issues" linkLabel="Link to heading: SSR issues">
  SSR issues
</Heading>
...
<Heading
  tag="h2"
  id="in-react-19-era"
  linkLabel="Link to heading: In React 19 era"
>
  In React 19 era
</Heading>
...
<Heading
  tag="h3"
  id="props-improvements"
  linkLabel="Link to heading: Props improvements"
>
  Props improvements
</Heading>
...
<Heading
  tag="h3"
  id="event-handling-improvements"
  linkLabel="Link to heading: Event handling improvements"
>
...
<Heading
  tag="h3"
  id="ssr-improvements"
  linkLabel="Link to heading: SSR improvements"
>
  SSR improvements
</Heading>
