...
<Heading
  ...
  linkLabel="Link to heading: Core design principles"
>
...
<Heading
  tag="h2"
  id="getting-started"
  linkLabel="Link to heading: Getting started"
>
  Getting started
</Heading>
...
<Heading tag="h3" id="vscode-setup" linkLabel="Link to heading: VSCode setup">
  VSCode setup
</Heading>
...
<Heading
  tag="h3"
  id="deno-config-file"
  linkLabel="Link to heading: Deno config file"
>
  Deno config file
</Heading>
...
<Heading tag="h2" id="jsr" linkLabel="Link to heading: JSR">
  JSR
</Heading>
...
<Heading tag="h3" id="jsr-example" linkLabel="Link to heading: Example">
  Example
</Heading>
...
<Heading tag="h3" id="jsr-developer-experience-advantages" linkLabel="Link to heading: Developer Experience Advantages">
...
<Heading tag="h3" id="jsr-tradeoffs" linkLabel="Link to heading: Tradeoffs">
  Tradeoffs
</Heading>
...
<Heading
  tag="h2"
  id="standard-library"
  linkLabel="Link to heading: Standard library"
>
  Standard library
</Heading>
...
<Heading tag="h2" id="summary" linkLabel="Link to heading: Summary">
  Summary
</Heading>
...
<Heading tag="h3" id="advantages" linkLabel="Link to heading: Advantages">
  Advantages
</Heading>
...
<Heading tag="h3" id="tradeoffs" linkLabel="Link to heading: Tradeoffs">
  Tradeoffs
</Heading>
