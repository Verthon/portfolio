...
<Heading
  tag="h2"
  id="what-information-code-coverage-gives-us"
  linkLabel="Link to heading: What information code coverage gives us ?"
>
...
<Heading
  tag="h2"
  id="what-information-code-coverage-wont-give-you"
  linkLabel="Link to heading: What information code coverage won't give you"
>
...
<Heading
  tag="h2"
  id="the-code-coverage-requirements"
  linkLabel="Link to heading: The code coverage requirements"
>
