---
title: 'Headless UI Libraries: Flexible, Accessible User Interfaces'
...
<ArticleWrapper>
<ArticleHeader>
<Heading tag='h1'>Headless UI Libraries: Flexible, Accessible User Interfaces</Heading>
</ArticleHeader>
...
<Heading tag="h2" id="why-to-think-about-it" linkLabel="Link to heading: Why to even think about it?">Why to even think about it?</Heading>
...
<Heading tag="h2" id="when-to-choose-headless-option" linkLabel="Link to heading: When to choose a headless option?">When to choose a headless option?</Heading>
...
<Heading tag="h2" id="are-traditional-ui-libraries-obsolete" linkLabel='Link to heading: Are "traditional" UI Libraries obsolete then?'>Are "traditional" UI Libraries obsolete then?</Heading>
...
<Heading tag="h2" id="drawbacks-of-headless-ui" linkLabel="Link to heading: Drawbacks of headless UI">Drawbacks of headless UI</Heading>
