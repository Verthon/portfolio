...
<Heading
  tag="h2"
  id="why-to-think-about-it"
  linkLabel="Link to heading: Why to even think about it?"
>
...
<Heading
  tag="h2"
  id="when-to-choose-headless-option"
  linkLabel="Link to heading: When to choose a headless option?"
>
...
<Heading
  tag="h2"
  id="are-traditional-ui-libraries-obsolete"
  linkLabel='Link to heading: Are "traditional" UI Libraries obsolete then?'
>
...
<Heading
  tag="h2"
  id="drawbacks-of-headless-ui"
  linkLabel="Link to heading: Drawbacks of headless UI"
>
