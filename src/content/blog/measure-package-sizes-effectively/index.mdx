...
import pkgSizeResultGeneral from './pkg-size-result-general.jpg'
import pkgSizeBundleSize from './pkg-size-bundle-size.jpg'
import bundlejsResults from './bundlejs-results.jpg'
...
<Alert variant="danger" marginBottomInRems={1}>
  **Update:** pkg-size.dev is currently not working. There is an open [GitHub
  issue](https://github.com/privatenumber/pkg-size.dev/issues/36) tracking this
  problem. In the meantime, consider using [bundlejs](https://bundlejs.com/) as
  an alternative.
</Alert>
