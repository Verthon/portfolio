...
description: 'Add Babel and React to a Webpack boilerplate: preset config, JSX transforms, and how the loader chain fits the setup from Part 1.'
...
<Heading tag="h2" id="babel-setup" linkLabel="Link to heading: Babel setup">Babel setup</Heading>
...
<Heading tag="h2" id="environment-variables" linkLabel="Link to heading: Environment variables">Environment variables</Heading>
...
<Heading tag="h2" id="react" linkLabel="Link to heading: React">React</Heading>
