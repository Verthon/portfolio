...
<Heading tag="h2" id="babel-setup" linkLabel="Link to heading: Babel setup">
  Babel setup
</Heading>
...
<Heading
  ...
  linkLabel="Link to heading: Environment variables"
>
...
<Heading tag="h2" id="react" linkLabel="Link to heading: React">
  React
</Heading>
