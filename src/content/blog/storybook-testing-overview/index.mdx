...
<Heading
  tag="h2"
  id="component-tests-in-the-storybook"
  linkLabel="Link to heading: Component Tests in Storybook"
>
...
<Heading
  tag="h3"
  id="how-storybook-component-tests-works"
  linkLabel="Link to heading: Storybook component tests internals"
>
...
<Heading
  tag="h3"
  id="example-test-breakdown"
  linkLabel="Link to heading: Example test breakdown"
>
...
<Heading
  tag="h3"
  id="example-test-with-http-request"
  linkLabel="Link to heading: Example test with HTTP request"
>
...
<Heading tag="h2" id="headless-mode" linkLabel="Link to heading: Headless mode">
  Headless mode
</Heading>
...
<Heading
  tag="h3"
  id="quick timing overview"
  linkLabel="Link to heading: CI Timing overview"
>
  CI Timing overview
</Heading>
...
<Heading
  tag="h2"
  id="test-coverage-capabilities"
  linkLabel="Link to heading: Gathering test coverage capabilities"
>
