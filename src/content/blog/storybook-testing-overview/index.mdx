...
import storybookUiTest from './storybook-ui-test.jpg'
...
<ArticleContent>
<Heading tag='h2' id='why-storybook' linkLabel='Link to heading: Why Storybook ?'>Why Storybook ?</Heading>
...
<Heading tag="h2" id="component-tests-in-the-storybook" linkLabel="Link to heading: Component Tests in Storybook">Component Tests in Storybook</Heading>
...
<Heading tag="h3" id="how-storybook-component-tests-works" linkLabel="Link to heading: Storybook component tests internals">Storybook component tests internals</Heading>
...
<Alert variant="info" marginBottomInRems={1}>
  Test runner verifies stories **without** the `play` function for rendering
  without errors
</Alert>
...
<Heading tag="h3" id="initial-setup" linkLabel="Link to heading: Initial setup">Initial setup</Heading>
...
<Heading tag="h3" id="example-test-breakdown" linkLabel="Link to heading: Example test breakdown">Example test breakdown</Heading>
...
<Heading tag="h3" id="example-test-with-http-request" linkLabel="Link to heading: Example test with HTTP request">Example test with HTTP request</Heading>
...
export const ErrorState: StoryObj<typeof UserProfile> = {
  ...
  play: async ({ canvasElement }) => {
    ...
    const errorInfo = await canvas.findByText(
...
<Heading tag="h2" id="headless-mode" linkLabel="Link to heading: Headless mode">Headless mode</Heading>
...
<Heading tag="h3" id="quick timing overview" linkLabel="Link to heading: CI Timing overview">CI Timing overview</Heading>
...
<Heading tag="h2" id="test-coverage-capabilities" linkLabel="Link to heading: Gathering test coverage capabilities">Gathering test coverage capabilities</Heading>
