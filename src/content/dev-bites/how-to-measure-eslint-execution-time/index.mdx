...
description: 'Use the TIMING env var to rank ESLint rules by execution time, find the one rule eating most of your lint run, and decide whether to keep it.'
tags: linter
date: 2024-08-03
