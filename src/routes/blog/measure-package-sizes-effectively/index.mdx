...
Things dying fast so you might also checkout curated list about similar tooling [here](https://github.com/styfle/packagephobia?tab=readme-ov-file#how-is-this-different)
