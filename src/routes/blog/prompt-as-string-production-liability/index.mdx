...
og_title: 'Prompt as a string is a production liability'
og_description: 'Why structured output from your LLM provider is not a contract, and what changes when the prompt becomes a typed, testable function. With a small ticket-classifier PoC'
...
<Heading tag='h2' id='shape-of-problem' linkLabel='Link to heading: The shape of the problem'>The shape of the problem</Heading>
...
<Heading tag='h2' id='class-of-tool' linkLabel='Link to heading: What this class of tool gives you'>What this class of tool gives you</Heading>
...
<Heading tag='h2' id='what-it-doesnt-give-you' linkLabel="Link to heading: What it doesn't give you">What it doesn't give you</Heading>
