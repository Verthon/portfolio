...
<ArticleContent>
<Heading tag='h2' id='code-coverage' linkLabel='Link to heading: Code coverage'>Code coverage</Heading>
...
<Heading tag='h2' id='what-information-code-coverage-gives-us' linkLabel='Link to heading: What information code coverage gives us ?'>What information code coverage gives us ?</Heading>
...
<Heading tag='h2' id='what-information-code-coverage-wont-give-you' linkLabel="Link to heading: What information code coverage won't give you">What information code coverage won't give you</Heading>
...
<Heading tag='h2' id='the-code-coverage-requirements' linkLabel='Link to heading: The code coverage requirements'>The code coverage requirements</Heading>
