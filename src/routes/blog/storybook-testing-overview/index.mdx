...
<Heading tag="h2" id="component-tests-in-the-storybook">
...
<Heading tag="h3" id="how-storybook-component-tests-works">
...
<Heading tag="h3" id="example-test-breakdown">
...
<Heading tag="h3" id="example-test-with-http-request">
...
<Heading tag="h2" id="headless-mode">
  Headless mode
</Heading>
...
<Heading tag="h3" id="quick timing overview">
  CI Timing overview
</Heading>
...
<Heading tag="h2" id="test-coverage-capabilities">
