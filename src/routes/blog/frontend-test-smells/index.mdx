...
date: 2022-10-30
excerpt: A Guide to Identifying and Fixing Test Smells. Discover the subtle yet impactful mistakes that can occur in frontend testing and how to rectify them. This article provides a comprehensive overview of common test smells, including the misuse of user events and the pitfalls of redundant assertions.
