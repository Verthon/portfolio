...
<Heading tag="h2" id="rsdoctor-bundler-support" linkLabel="Link to heading: RSDoctor bundler support">
...
<Heading tag="h2" id="features-breakdown" linkLabel="Link to heading: RSDoctor features breakdown">
...
<Heading tag="h3" id="bundle-size-analysis" linkLabel="Link to heading: Bundle size analysis">
...
<Heading tag="h3" id="compilation-visualization" linkLabel="Link to heading: Compilation Visualization">
