...
<ArticleContent>
<Heading tag='h2' id='what-is-pnpm' linkLabel='Link to heading: What is pnpm ?'>What is pnpm ?</Heading>
...
<Heading tag='h3' id='why-pnpm-is-faster' linkLabel='Link to heading: Why pnpm is faster ?'>Why pnpm is faster ?</Heading>
...
<Heading tag='h3' id='smaller-node-modules' linkLabel='Link to heading: Smaller node_modules'>Smaller node_modules</Heading>
...
<Heading tag='h3' id='more-strict-than-npm' linkLabel='Link to heading: More strict than npm'>More strict than npm</Heading>
...
<Heading tag='h3' id='how-to-migrate' linkLabel='Link to heading: How to migrate'>How to migrate</Heading>
...
<Heading tag='h3' id='metrics' linkLabel='Link to heading: Metrics'>Metrics</Heading>
...
<Heading tag='h3' id='monorepo' linkLabel='Link to heading: Monorepo'>Monorepo</Heading>
